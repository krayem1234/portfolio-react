export const profile = {
  ...
  // Clé gratuite obtenue sur https://web3forms.com/ (entrer ton email, la clé
  // arrive par mail). Tant qu'elle est vide, le formulaire de contact utilise
  // un simple lien "mailto:" comme solution de repli — dès qu'une clé est
  // renseignée ici, les messages sont envoyés silencieusement, sans ouvrir
  // le client mail du visiteur.
  web3formsKey: '8b300ceb-a848-4e74-9679-d5fb6e27494a',
}
